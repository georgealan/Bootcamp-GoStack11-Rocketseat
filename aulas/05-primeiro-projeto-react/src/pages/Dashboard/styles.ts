...
/**
 * A propriedade css acima no import do styled-components serve para adicionar css puro em funções
 * que necessitam.
 */
...
export const Form = styled.form<FormProps>`
  ...
  input {
    ...
    /* Aqui utilizamos o css do styled-components que foi importado acima. */
    ${props =>
      props.hasError &&
      css`
        border-color: #c53030;
